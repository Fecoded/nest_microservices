...
/***/ "./apps/orders/src/constants/service.ts":
/*!**********************************************!*\
  !*** ./apps/orders/src/constants/service.ts ***!
  \**********************************************/
...
let OrdersController = class OrdersController {
    ...
    async createOrder(request, req) {
        var _a;
        return await this.ordersService.createOrder(request, (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.Authentication);
    }
    async getOrders() {
...
__decorate([
    (0, common_2.UseGuards)(common_1.JwtAuthGuard),
    (0, common_2.Post)(),
...
const service_1 = __webpack_require__(/*! ./constants/service */ "./apps/orders/src/constants/service.ts");
    ...
    (0, common_2.Module)({
        imports: [
            ...
            common_1.RmqModule.register({
                name: service_1.BILLING_SERVICE,
            }),
            common_1.AuthModule,
        ],
...
OrdersService = __decorate([
    (0, common_1.Injectable)(),
    __param(1, (0, common_1.Inject)(service_1.BILLING_SERVICE)),
